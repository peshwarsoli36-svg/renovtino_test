...
const PERKS = [
  {
    ...
    description: "Know your chair is secured the moment you book.",
  },
  {
    title: "Easy rescheduling",
    description: "Plans change — move your appointment in seconds.",
  },
  {
    title: "Friendly reminders",
    description: "A gentle SMS nudge the day before your visit.",
  },
];
        ...
        <div className="flex flex-col gap-8">
          <Reveal className="flex flex-col gap-4">
            ...
            <p className="max-w-md text-base leading-relaxed text-muted-foreground sm:text-lg">
              Pick a service and a time that suits you. It only takes a minute.
            </p>
          </Reveal>
